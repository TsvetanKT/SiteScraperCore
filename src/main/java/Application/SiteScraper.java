...
public class SiteScraper {
    ...
    public List<String> getIteration(String sourceName, String query, int iteration) {
        ...
        if (query == null || query.isEmpty() || sourceName == null || sourceName.isEmpty()) {
            return null;
        }

        SourceObj sourceObj = sources.stream().filter(s -> s.getSourceName().equals(sourceName))
                .findFirst().get();
        ...
        switch (sourceObj.getType()) {
            ...
            default:
                throw new NotImplementedException(
                        "Not implemented extract type " + sourceObj.getType());
        }
